...
void soft_vm_test_dynamic_bitwise(void ** state)
{
	...
	struct soft_instr instructions[] = {
		sinstr(loadi_qw, 1, soft_rax, 0),
		sinstr(loadi_qw, 1, soft_rbx, 8),
		sinstr(loadi_qw, 1, soft_rcx, 16),
		sinstr(loadi_qw, 1, soft_rdx, 24),
		...
		sinstr(loadi_qw, 0, soft_rax, 32),
		sinstr(loadi_qw, 0, soft_rbx, 40),
