...
void soft_vm_test_jmp(void ** state)
{
	struct soft_instr instructions[] = {
		sinstr(load_dw, 0, soft_rax, 2 * sizeof(sval_t) / sizeof(char)),
		sinstr(jmp, soft_rax, 0, 0),
		sinstr(load_dw, 0, soft_rax, 1 * sizeof(sval_t) / sizeof(char)),
		sinstr(halt, 0, 0, 0),
		sinstr(load_dw, 0, soft_rax, 0 * sizeof(sval_t) / sizeof(char)),
		sinstr(halt, 0, 0, 0),
	};
...
void soft_vm_test_jmpz(void ** state)
{
	struct soft_instr instructions[] = {
		sinstr(load_dw, 0, soft_rax, 2 * sizeof(sval_t) / sizeof(char)),
		sinstr(load_dw, 0, soft_rbx, 0 * sizeof(sval_t) / sizeof(char)),
...
void soft_vm_test_jmpnz(void ** state)
{
	struct soft_instr instructions[] = {
		...
		sinstr(load_dw, 0, soft_rcx, 0 * sizeof(sval_t) / sizeof(char)),
...
void soft_vm_test_jmpgte(void ** state)
{
	struct soft_instr instructions[] = {
		...
		sinstr(halt, 0, 0, 0),
		sinstr(load_dw, 0, soft_rax, 3 * sizeof(sval_t) / sizeof(char)),
		sinstr(dcmp, soft_rbx, 0, soft_rbx),
		sinstr(jmpgte, soft_rax, 0, 0),
		sinstr(halt, 0, 0, 0),
		sinstr(load_dw, 0, soft_rax, 0 * sizeof(sval_t) / sizeof(char)),
