...
static void soft_vm_test_load_reg_int32(void **state)
{
	...
	soft_instr test_program[] = {
		...
		{ soft_load, soft_int32_t,  noop,  0x1,  {test_data.soft_int32} },
...
static void soft_vm_test_load_reg_float(void **state)
{
	...
	soft_instr test_program[] = {
		// opcode,   datatype,      src,   dest, immediate
		{ soft_load, soft_float_t,  noop,  0x1,  {test_data.soft_int32} },
		{ halt,      noop,          noop,  noop, {noop} }
	};
...
static void soft_vm_test_add_float_reg(void **state)
{
	...
	soft_instr test_program[] = {
		// opcode,   datatype,      src,   dest, immediate
		{ soft_load, soft_float_t,  noop,  0x1,  {float_1.soft_int32} },
		{ soft_load, soft_float_t,  noop,  0x2,  {float_2.soft_int32} },
		{ soft_add,  soft_float_t,  0x1,   0x2,  {noop} },
		{ halt,      noop,          noop,  noop, {noop} }
	};
