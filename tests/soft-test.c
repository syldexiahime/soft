...
int main(void) {
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test(soft_vm_test_dynamic_arithmetic_int),
		cmocka_unit_test(soft_vm_test_dynamic_arithmetic_double),
		cmocka_unit_test(soft_vm_test_dynamic_arithmetic_string),
		#endif
